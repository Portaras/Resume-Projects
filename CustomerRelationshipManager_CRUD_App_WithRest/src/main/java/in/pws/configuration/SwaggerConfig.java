...
//				apis(RequestHandlerSelectors.basePackage("in.pws.controller"))// base packages for//
//																						// RestController
//				.paths(PathSelectors.regex("/api/customer.*")).// To specify the request paths
